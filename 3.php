...
class Calculation
{
  private $tarifLightRussianPost = 100; // тариф Почты России на посылку до 10 кг.
  private $tarifHightRissianPost = 1000; // тариф Почты России на посылку свыше 10 кг
  private $tarifDHL = 100; // тариф DHL универсальный

  public function russianPostPrice ($weight) { // формула расчета Почта России
    if (0 < $weight && $weight <= 10) {
      return $weight * $this->tarifLightRussianPost;
    } else {
      return $weight * $this->tarifHightRissianPost;
    }
  }

  public function  DHLPrice ($weight) { // формула расчета DHL
    return $weight * $this->tarifDHL;
  }
}

/*
* Пример использования DHL
* $dhl = new Calculation;
* echo "Стоимость перевозки DHL: {$dhl->DHLPrice(10)} рублей<br>";
*
* Пример использования Почта России
* $rp = new Calculation;
* echo "Стоимость перевозки Почта России: {$rp->russianPostPrice(11)} рублей<br>";
*/